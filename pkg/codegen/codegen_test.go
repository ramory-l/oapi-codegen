...
const (
	...
	remoteRefImport = `github.com/ramory-l/oapi-codegen/v2/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/ramory-l/oapi-codegen/v2/examples/petstore-expanded"`)
