...
//go:generate go run github.com/ramory-l/oapi-codegen/v2/cmd/oapi-codegen --config=models.cfg.yaml ../../petstore-expanded.yaml
//go:generate go run github.com/ramory-l/oapi-codegen/v2/cmd/oapi-codegen --config=server.cfg.yaml ../../petstore-expanded.yaml
...
import (
	...
	"github.com/ramory-l/oapi-codegen/v2/examples/petstore-expanded/echo-v5/api/models"
)
