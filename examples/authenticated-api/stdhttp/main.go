...
import (
	...
	"github.com/ramory-l/oapi-codegen/v2/examples/authenticated-api/stdhttp/api"
	"github.com/ramory-l/oapi-codegen/v2/examples/authenticated-api/stdhttp/server"
)
